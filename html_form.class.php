<?php
/* 
HTML_Form Code courtesy from http://www.dyn-web.com/, please log on the site for more information! 

*/

class HTML_Form {
    
    public static $MONTHS_LONG = array('January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December');
